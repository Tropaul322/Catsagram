...
function fetcher<TData, TVariables>(client: GraphQLClient, query: string, variables?: TVariables, headers?: RequestInit['headers']) {
  return async (): Promise<TData> => client.request<TData, unknown>(query, variables, headers);
}
...
export type GetByIdQuery = { __typename?: 'Query', cat: { __typename?: 'CatEntity', id: string, createdAt: unknown, url: string, likes: number, comments: Array<{ __typename?: 'CommentEntity', id: string, text: string, createdAt: unknown, updatedAt: unknown }> } };
